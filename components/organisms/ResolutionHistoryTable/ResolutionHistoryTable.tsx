    ...
    <div className="bg-white border border-slate-200 rounded-xl overflow-hidden shadow-sm">
      ...
      {entries.length === 0 ? (
        <div className="p-10 text-center">
          <TypographyMuted>No conflict resolutions recorded yet.</TypographyMuted>
        </div>
      ) : (
        <>
          {/* Table */}
            ...
            <table className="w-full text-sm text-left">
              <thead className="bg-slate-50 border-b border-slate-200 text-slate-500">
                <tr>
                  ...
                  <th className="px-6 py-3 font-medium">Previous Version</th>
                  <th className="px-6 py-3 font-medium">Resolved Version</th>
                  ...
                  <>
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        <Badge variant="outline">v{entry.previousVersion}</Badge>
                      </td>
                      <td className="px-6 py-4">
